 ...
 * 
 * TENANT: ADM (gerente local) - todas as queries devem filtrar por adm_id via Specifications.
...
public class Delivery extends BaseEntity {
    ...
    @Column(name = "from_lat", precision = 10, scale = 7)
    @Visible(table = false, form = true, filter = false)
    private Double fromLatitude;

    
    @Column(name = "from_lng", precision = 10, scale = 7)
    @Visible(table = false, form = true, filter = false)
    ...
    @Column(name = "to_lat", precision = 10, scale = 7)
    @Visible(table = false, form = true, filter = false)
    private Double toLatitude;

    
    @Column(name = "to_lng", precision = 10, scale = 7)
    @Visible(table = false, form = true, filter = false)
