...
public class StripePaymentProvider implements PaymentProvider {
    ...
    public BigDecimal calculateFee(BigDecimal amount, Payment.PaymentMethod paymentMethod) {
        BigDecimal percentageFee = amount.multiply(
                paymentMethod == Payment.PaymentMethod.CREDIT_CARD ? CREDIT_CARD_PERCENTAGE : DEBIT_CARD_PERCENTAGE);
    ...
    /**
     * Converts Stripe payment status to internal Payment.PaymentStatus
     */
    private Payment.PaymentStatus convertStripeStatus(String stripeStatus) {
