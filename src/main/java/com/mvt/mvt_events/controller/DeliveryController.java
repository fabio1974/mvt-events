    ...
    private DeliveryResponse mapToResponse(Delivery delivery) {
        return DeliveryResponse.builder()
                ...
                .vehicle(delivery.getVehicle() != null ? DeliveryResponse.VehicleDTO.builder()
                        ...
                        .color(delivery.getVehicle().getColor() != null ? delivery.getVehicle().getColor().name() : null)
                        .year(delivery.getVehicle().getYear())
                        .isActive(delivery.getVehicle().getIsActive())
                        .build() : null)
