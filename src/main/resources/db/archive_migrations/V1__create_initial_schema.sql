-- ============================================================================
-- MIGRATION V1: COMPLETE INITIAL SCHEMA CREATION
-- ============================================================================
-- This migration creates all tables for the MVT Events system
-- Based on the production schema currently in use
...
-- ============================================================================
-- UNIQUE INDEXES (with existence handling)
-- ============================================================================
DO $$
BEGIN
...
-- SEQUENCES
-- ============================================================================
-- Sequences are created automatically by GENERATED BY DEFAULT AS IDENTITY

-- ============================================================================
-- COMMENTS
-- ============================================================================
COMMENT ON TABLE athletes IS 'Table of athletes registered in the system';
COMMENT ON TABLE organizations IS 'Table of organizations that create events';
COMMENT ON TABLE events IS 'Table of sports events';
COMMENT ON TABLE event_financials IS 'Table of event financial data';
COMMENT ON TABLE registrations IS 'Table of athlete registrations in events';
COMMENT ON TABLE payments IS 'Table of registration payments';
COMMENT ON TABLE transfers IS 'Table of transfers to organizations';
COMMENT ON TABLE payment_events IS 'Table of payment events for auditing';
COMMENT ON TABLE users IS 'Table of system users';