-- =====================================================
-- V76: Dados de Teste para Sobral-CE (Produção)
-- =====================================================
-- Adiciona motoboy, clientes e deliveries de teste
-- com coordenadas reais de Sobral-CE
-- =====================================================

-- =====================================================
-- 1. LIMPAR DELIVERIES EXISTENTES
-- =====================================================
DELETE FROM deliveries;

-- =====================================================
-- 2. CRIAR NOVO MOTOBOY (Motoboy2)
-- =====================================================
...
VALUES (
    ...
    'COURIER',
    1058, -- Sobral
    NULL, -- Couriers não têm organization_id
    true,
    NOW(),
    NOW(),
    -3.6969445, -- Posição no meio da rota (IN_TRANSIT)
    -40.3581945
)
...
-- =====================================================
-- 3. ATUALIZAR GPS DO MOTOBOY1 (posição no meio da rota)
-- =====================================================
UPDATE users 
SET gps_latitude = -3.6969445, 
    gps_longitude = -40.3494445,
    updated_at = NOW()
WHERE id = '6186c7af-2311-4756-bfc6-ce98bd31ed27'::uuid;

-- =====================================================
-- 4. CRIAR 3 NOVOS CLIENTES DE SOBRAL
-- =====================================================
...
-- =====================================================
-- 5. CRIAR DELIVERIES COM STATUS DIVERSOS
-- =====================================================
...
-- Delivery 7: IN_TRANSIT - Sushi (Motoboy2 no meio da rota)
INSERT INTO deliveries (
    client_id, courier_id, organizer_id,
    from_address, from_lat, from_lng,
    to_address, to_lat, to_lng,
...
-- Delivery 8: IN_TRANSIT - Padaria1 (Motoboy1 no meio da rota)
INSERT INTO deliveries (
    client_id, courier_id, organizer_id,
    from_address, from_lat, from_lng,
    to_address, to_lat, to_lng,
...
-- RESUMO DA MIGRATION
-- =====================================================
-- ✅ Deliveries existentes removidas
-- ✅ 1 novo motoboy (Motoboy2) com GPS atualizado
-- ✅ GPS do Motoboy1 atualizado (meio da rota)
-- ✅ 3 novos clientes (Posto, Farmácia, Sushi)
-- ✅ 12 deliveries com status diversos:
--    - 3 PENDING (sem courier/organizer)
--    - 2 ACCEPTED (com courier/organizer)
--    - 1 PICKED_UP
--    - 2 IN_TRANSIT (motoboys com GPS no meio das rotas)
--    - 3 COMPLETED
--    - 1 CANCELLED
-- ✅ Todos com endereços e coordenadas reais de Sobral-CE
-- =====================================================
